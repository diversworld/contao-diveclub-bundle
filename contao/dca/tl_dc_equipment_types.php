...
$GLOBALS['TL_DCA']['tl_dc_equipment_types'] = [
    ...
    'list'              => [
        ...
        'label'         => [
            ...
            'fields'        => ['title','subType'],
            'label_callback' => ['tl_dc_equipment_types', 'subTypeLabel'], // Callback zum Anpassen
        ],
        'global_operations' => [
            'all'       => [
                'href'      => 'act=select',
    ...
    'fields'        => [
        ...
        'alias'         => [
            ...
            'save_callback'     => [
                ['tl_dc_equipment_types', 'generateAlias']
            ],
        ...
        'notes'         => [
            'inputType'         => 'textarea',
            'label'             => &$GLOBALS['TL_LANG']['tl_dc_equipment_types']['notes'],
            'exclude'           => true,
            'search'            => false,
            'filter'            => false,
            'sorting'           => false,
        ...
        'published'     => [
            'inputType'         => 'checkbox',
            'label'             => &$GLOBALS['TL_LANG']['tl_dc_equipment_types']['published'],
            'toggle'            => true,
            'filter'            => true,
        ...
        'start'         => [
            'inputType'         => 'text',
            'label'             => &$GLOBALS['TL_LANG']['tl_dc_equipment_types']['start'],
...
class tl_dc_equipment_types extends Backend
{
    ...
    private function getTemplateOptions($templateName)
    {
        ...
        $moduleTemplatePath = Controller::getTemplate($templateName);
