 ...
 * Legends
 */
$GLOBALS['TL_LANG']['tl_calendar_events']['dive_legend'] = "Dive Manager Einstellungen";
 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_calendar_events']['addCheckInfo'] = ["TÜV-Termin", "Informationen zum TÜV-Terminen erfassen."];
...
$GLOBALS['TL_LANG']['tl_calendar_events']['addCourseInfo'] = ["Tauchkursinfos", "Kurspreis und -kategorie erfassen."];
...
$GLOBALS['TL_LANG']['tl_calendar_events']['vendorMobile'] = ["Mobilnummer", "Geben Sie die Mobilnummer ein."];
...
$GLOBALS['TL_LANG']['tl_calendar_events']['courseFee'] = ["Kursgebühr", "Die Kosten für die Teilnahme am Kurs."];
$GLOBALS['TL_LANG']['tl_calendar_events']['category'] = ["Kurskategorie", "Bitte die Kategorie des Tauchkurses auswählen.."];

/**
 * References
 */
$GLOBALS['TL_LANG']['tl_calendar_events']['basicOption'] = "Beginner";
$GLOBALS['TL_LANG']['tl_calendar_events']['advancedOption'] = "Specialty";
$GLOBALS['TL_LANG']['tl_calendar_events']['professionalOption'] = "Professionell";
$GLOBALS['TL_LANG']['tl_calendar_events']['technicalOption'] = "Technisch";
