 ...
 * Legends
 */
$GLOBALS['TL_LANG']['tl_dc_check_proposal']['title_legend'] = "Rechnungsdaten";
$GLOBALS['TL_LANG']['tl_dc_check_proposal']['details_legend'] = "Details zur Rechnung";
$GLOBALS['TL_LANG']['tl_dc_check_proposal']['notes_legend'] = "Bemerkungen zur Rechnung";
$GLOBALS['TL_LANG']['tl_dc_check_proposal']['publish_legend'] = "Veröffentlichen";

/**
 * Fields
 */
$GLOBALS['TL_LANG']['tl_dc_check_proposal']['addCheckInfo'] = ["Daten zum TÜV-Termin erfassen", "Informationen zum TÜV-Termin erfassen"];
$GLOBALS['TL_LANG']['tl_dc_check_proposal']['addVendorInfo'] = ["Prüfungsunternehmen", "Informationen zum Prüfungsunternehmen erfassen."];
...
$GLOBALS['TL_LANG']['tl_dc_check_proposal']['tuv_list'] = ['TÜV-Liste', 'Erstellt eine PDF-Liste aller gebuchten Tauchgeräte für diesen Termin.'];
...
$GLOBALS['TL_LANG']['tl_dc_check_proposal']['published'] = ["Veröffentlichen", "Den Datensatz veröffentlichen."];
...
$GLOBALS['TL_LANG']['tl_dc_check_proposal']['orders'] = ['Bestellungen', 'Buchungen für dieses Angebot anzeigen'];
