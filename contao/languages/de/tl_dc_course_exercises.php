...
$GLOBALS['TL_LANG']['tl_dc_course_exercises']['new'] = ['Neue Übung', 'Neue Übung erstellen'];
$GLOBALS['TL_LANG']['tl_dc_course_exercises']['edit'] = ['Übung bearbeiten', 'Übung ID %s bearbeiten'];
$GLOBALS['TL_LANG']['tl_dc_course_exercises']['copy'] = ['Übung duplizieren', 'Übung ID %s duplizieren'];
$GLOBALS['TL_LANG']['tl_dc_course_exercises']['delete'] = ['Übung löschen', 'Übung ID %s löschen'];
...
$GLOBALS['TL_LANG']['tl_dc_course_exercises']['start'] = ['Startdatum', 'Geben Sie ein Startdatum an.'];
$GLOBALS['TL_LANG']['tl_dc_course_exercises']['stop'] = ['Enddatum', 'Geben Sie ein Enddatum an.'];
