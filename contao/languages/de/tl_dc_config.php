...
$GLOBALS['TL_LANG']['tl_dc_config']['manufacturer_template'] = ['Hersteller-Template', 'Eine neue Template-Konfiguration anlegen'];
$GLOBALS['TL_LANG']['tl_dc_config']['sizes_template'] = ['Größen-Template', 'Eine neue Template-Konfiguration anlegen'];
$GLOBALS['TL_LANG']['tl_dc_config']['equipment_template'] = ['Ausrüstungs-Template', 'Eine neue Template-Konfiguration anlegen'];
$GLOBALS['TL_LANG']['tl_dc_config']['types_template'] = ['Typen-Template', 'Eine neue Template-Konfiguration anlegen'];
$GLOBALS['TL_LANG']['tl_dc_config']['regulator_template'] = ['Atemregler-Template', 'Eine neue Template-Konfiguration anlegen'];
