...
$GLOBALS['TL_LANG']['tl_module']['courseProgressJumpTo'] = ['Zielseite für den Kursfortschritt', 'Wählen Sie die Seite, auf der das Frontend-Modul „Kursfortschritt“ eingebunden ist. Ohne diese Zielseite werden in der Kursübersicht keine Fortschrittslinks erzeugt.'];
$GLOBALS['TL_LANG']['tl_module']['courseConfirmationJumpTo'] = ['Bestätigungsseite nach der Kursanmeldung', 'Wählen Sie die Seite, die nach einer erfolgreichen Kursanmeldung angezeigt wird. Auf der Zielseite ist kein weiteres Frontend-Modul erforderlich; die Anmeldedaten können dort mit {{course::*}}-Insert-Tags ausgegeben werden. Ohne Zielseite bleibt der Nutzer auf der Reader-Seite.'];
$GLOBALS['TL_LANG']['tl_module']['tankConfirmationJumpTo'] = ['Zielseite für die TÜV-Buchungsbestätigung', 'Wählen Sie die Seite, auf der das Frontend-Modul „Buchungsbestätigung (TÜV)“ eingebunden ist. Die Buchungsdaten werden vor der Weiterleitung in der Session gespeichert. Ohne Zielseite zeigt das Buchungsmodul die Bestätigung selbst an.'];
$GLOBALS['TL_LANG']['tl_module']['tankCheckJumpTo'] = ['Zielseite für TÜV-Buchungen', 'Wählen Sie die Seite, auf der das Frontend-Modul „Flaschenprüfung (TÜV)“ eingebunden ist. Die Links der veröffentlichten TÜV-Termine führen auf diese Buchungsseite.'];
$GLOBALS['TL_LANG']['tl_module']['courseJumpTo'] = ['Zielseite für Kursveranstaltungen', 'Wählen Sie die Seite, auf der das Frontend-Modul „Kursveranstaltung (Reader)“ eingebunden ist. Die Links der veröffentlichten Kursveranstaltungen führen auf diese Detail- und Anmeldeseite.'];
