...
$GLOBALS['TL_LANG']['tl_dc_equipment']['serialNumber']      = ['Serialnumber', 'Please enter the serialnumber.'];
$GLOBALS['TL_LANG']['tl_dc_equipment']['buyDate']           = ['Buydate', 'Choose the Date when it was bought.'];
